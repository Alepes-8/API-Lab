...
export const healthCheck = async (req, res) => {
    res.status(STATUS_CODES.SUCCESS).json({apiCalled: 'ok', env: process.env.NODE_ENV, version: process.env.APP_VERSION, sha: process.env.BUILD_SHA, mongoStatus: await checkMongoAlive(), extraInfo: "test"})
}
