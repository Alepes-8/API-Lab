...
**HOMELAB_DISPATCH_TOKEN** is a token allowing the project to call the home_lab setup and tell it to do a specific action through the github actions. in the current setup, it tells the staging that it should get the image with the current staging tag.
